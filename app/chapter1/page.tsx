    ...
    <div className="min-h-screen bg-brand-yellow text-black relative">
      ...
      <section className="w-full bg-[#FED9D0] py-20 px-6 md:px-12 lg:px-24 text-black">
        <div className="max-w-[1920px] mx-auto flex flex-col gap-16 font-sans">
          ...
          {/* Devices Row */}
          <div className="flex flex-col sm:flex-row gap-8 items-center justify-center lg:justify-start w-full">
            <div className="w-full sm:w-[48%] md:w-[45%] max-w-[450px] flex items-center justify-center">
              <Image 
                src="/Onboarding.svg" 
